  ...
  >
    <h2>
      <button
        ...
        :style="{
          'background-color': active ? buttonActiveBackgroundColor : buttonInactiveBackgroundColor,
    ...
    >
      ...
      >
        ...
        <div
          ...
          :style="{
            'flex-direction': item.flex_dir,
            'align-items': item.flex_align,
            'justify-content': item.flex_justify,
            gap: item.flex_gap,
            'line-height': item.flex_line_height,
            margin: item.flex_margin
          }"
        >
          <div
...
.accordion-container {
  ...
  margin: $margin calc(($margin + $left-border-width/2) * -1) $margin
    calc(($margin + $left-border-width/2) * -1);
  overflow: hidden;
