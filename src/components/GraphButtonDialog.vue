<template>
  <div>
    ...
    >
      <button
        class="explanation-button info-button"
        @click="showExplanationDialog"
      >
        <span
          class="button-icon"
          aria-hidden="true"
    ...
    <DialogBox
      v-model="explanationDialogShown"
    >
      <template #dialogTitle>
        <div
          id="explanation-title-container"
        >
          <div
            class="explanation-button info-button static"
          >
            <span
              class="button-icon"
              aria-hidden="true"
...
<script setup>
  ...
  // global variables
  const explanationDialogShown = ref(false);

  function showExplanationDialog() {
    explanationDialogShown.value = true;
  }
</script>
...
.explanation-button .button-icon {
