export default {
    ...
    accordionData: [
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              "<span class='moderate-emph'>To view forecast conditions, select a future date using the date slider</span>. When forecast conditions are shown, the color of the circle indicates what category of streamflow drought is forecast rather than observed."
          },
          {
            type: 'text',
            content:
        ...
        content: [
          {
            type: 'text',
            content:
              "Streamflow drought has widespread and recurring impacts on industrial water supply, municipal water supply, hydropower, thermoelectric power, river navigation, irrigation, water quality, and aquatic organisms. <span class='moderate-emph'>Streamflow drought forecasts help decision makers anticipate periods of limited water availability</span> so they can develop plans for ensuring the safety and health of their communities."
          }
        ],
        activeOnLoad: false
      },
        ...
        content: [
          {
            type: 'text',
            content:
              "<span class='moderate-emph'>Meteorological drought</span> occurs when an area experiences a prolonged period of substantially less precipitation than normal, while streamflow drought occurs when streamflow is unusually low for the time of year."
          },
          {
            type: 'text',
            content:
        ...
        content: [
          {
            type: 'text',
            content:
              "<span class='moderate-emph'>Low flows</span> occur seasonally in many streams and are considered normal conditions. In contrast, <span class='moderate-emph'>streamflow drought</span> results when flows are unusually low for a given time of year compared to normal conditions."
          },
          {
            type: 'quote',
            content:
              '"While droughts may include periods of low flows, a recurring seasonal low flow event is not necessarily a drought."—<a href="https://library.wmo.int/idurl/4/32176" target="_blank">WMO, 2008</a>'
          },
          {
            type: 'text',
            content:
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              'When the map view includes a summary of streamflow drought conditions for CONUS or for an individual state, the reported percentages for each streamflow drought category are categorical, not cumulative.'
          },
          {
            type: 'text',
            content:
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              "To learn more, visit the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website or refer to the <a href='https://www.frontiersin.org/journals/water/articles/10.3389/frwa.2025.1709138' target='_blank'>technical documentation of modeling methods and model evaluation</a>."
          }
        ],
        activeOnLoad: false
      },
        ...
        content: [
          {
            type: 'text',
            content:
              "The maximum forecast horizon for this model is 13 weeks in the future. Weather forecasts are very limited for this timeframe, making streamflow percentile predictions and forecasts of streamflow drought highly uncertain. Nonetheless, these predictions provide more insight into future conditions than simply referencing median conditions from prior years. Please refer to the <a href='https://www.frontiersin.org/journals/water/articles/10.3389/frwa.2025.1709138' target='_blank'>technical documentation</a> for a detailed evaluation of our model’s ability to forecast streamflow drought occurrence as well as streamflow drought onset and termination and visit the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website for an overview of the modeling approach."
          }
        ],
        activeOnLoad: false
      },
        ...
        content: [
          {
            type: 'text',
            content:
              "The models currently deployed operationally have limited accuracy in predicting streamflow percentiles corresponding to streamflow drought occurrence or streamflow drought onset/termination more than 4 weeks into the future, and <span class='moderate-emph'>interpreting forecasts for 1-4 weeks may be most useful</span>. Continued model development can benefit from additional inputs, as this model incorporates limited data on subsurface storage and flow modifications, including reservoir releases, diversions, and withdrawals. In addition, there are difficulties in capturing sub-seasonal transitions between streamflow drought and flood conditions."
          },
          {
            type: 'text',
            content:
              "A known issue with the current modeling approach is that <span class='moderate-emph'>model predictions tend towards forecasts of streamflow drought occurrence being more likely for longer lead times</span>, which may overrepresent the prevalence of streamflow drought more than 4 weeks in advance."
          },
          {
            type: 'text',
            content:
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              "For <span class='moderate-emph'>perennial</span> sites with continuous streamflow throughout the year, no special considerations are needed for interpreting streamflow drought forecasts."
          },
          {
            type: 'flex',
            flex_dir: 'row',
          ...
          },
          {
            type: 'text',
            content:
              "At <span class='moderate-emph'>snow-dominated</span> sites and other sites with strong streamflow seasonality, changes in the timing of snowmelt or seasonal input may display as streamflow drought even if the amount of snowmelt is similar."
          },
          {
            type: 'flex',
            flex_dir: 'row',
          ...
          },
          {
            type: 'text',
            content:
              "At <span class='moderate-emph'>ice-impacted</span> sites, streamflow may be impacted by the presence of ice during cold times of the year. Frozen streams may appear to be abnormally low even when the site is not in streamflow drought."
          }
        ],
        activeOnLoad: false
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              'The 1981–2020 period of record is also used to convert predicted percentiles to units of streamflow – cubic feet per second (cfs) – when plotting the predicted streamflow (refer to ‘Why are predictions plotted in units of streamflow (cfs) instead of percentiles?’, below).'
          },
          {
            type: 'text',
            content:
        ...
        content: [
          {
            type: 'text',
            content:
              "No forecasts are provided if streamflow data are missing for all of the last 30 days. If streamflow data are available for part of this period, a <span class='moderate-emph'>prediction will be made using other input data</span> (refer to ‘How is streamflow drought forecast?’, above), but may be less accurate."
          }
        ],
        activeOnLoad: false
      },
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              "<h3>Issue date</h3>The chart is split vertically by a dotted line indicating the issue date — <span class='moderate-emph'>the date the forecasts were made</span>."
          },
          {
            type: 'text',
            content:
  ...
  icons: {
    normal: {
      ...
      paragraph1:
        'This site experiences perennial streamflow, meaning that it flows continuously throughout the year.',
      promptTrue: 'Site has perennial streamflow'
    },
    intermittent: {
      title: 'Non-perennial site',
      paragraph1:
        'This site experiences non-perennial streamflow, meaning that it dries at certain times of year.',
      paragraph2:
        'At sites with non-perennial streamflow, streamflow drought may occur due to longer stretches without streamflow rather than abnormally low streamflow. While the model uses a method that considers whether a continuous stretch without streamflow is longer than normal, familiarity with the general patterns of streamflow at these sites may be useful for interpreting these streamflow drought forecasts.',
      promptTrue: 'Site has non-perennial streamflow'
    },
    regulated: {
      title: 'Highly regulated site',
      paragraph1:
        'Streamflow at this site is highly regulated, due to storage of streamflow in upstream reservoirs.',
      paragraph2:
        'At highly regulated sites below dams, below normal streamflow percentiles may reflect streamflow drought in systems with over-year storage in irrigation and water supply reservoirs. However, reservoirs are often managed in coordination (for example releases from one reservoir may be stored in another), and evaluating the total reservoir storage in a watershed or basin can provide more information to models. Streamflow drought in areas with a high degree of flow regulation is dependent on historical patterns in water storage and release for the period 1981–2020. We assume reservoirs operate similarly to how they did during the 1981–2020 observed record.',
    ...
    snow: {
      ...
      paragraph1:
        "The hydrology of this site is considered to be snow-dominated because within the site's contributing drainage area, the peak snow water equivalent is at least 25% of the annual precipitation total. Snow water equivalent is a measure of the liquid water contained in snowpack.",
      paragraph2:
        'At snow-dominated sites and other sites with strong streamflow seasonality, changes in the timing of snowmelt or seasonal input may display as streamflow drought even if the amount of snowmelt is similar.',
    ...
    ice: {
      ...
      paragraph2:
        'At ice-impacted sites, streamflow may be impacted by the presence of ice during cold times of the year. Frozen streams may appear to be abnormally low even when the site is not in streamflow drought.',
