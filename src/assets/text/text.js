export default {
        ...
        accordionData: [
            {
                ...
                content: [
                    ...
                    {
                        type: "text",
                        content: "<span class='moderate-emph'>To view forecast conditions, select a future date using the date slider</span>. When forecast conditions are shown, the color of the circle indicates what category of streamflow drought is forecast rather than observed."
                    },
                    {
                        type: "text",
            ...
            },
            {
                ...
                content: [
                    ...
                    {
                        type: "text",
                        content: "For more information, please refer to the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website and the <a href='https://www.frontiersin.org/journals/water/articles/10.3389/frwa.2025.1709138' target='_blank'>technical documentation of modeling methods and model evaluation</a>."
                    }
                ],
                activeOnLoad: false
            },
            ...
            },
            {
                ...
                content: [
                    {
                        type: "text",
                        content: "The models currently deployed operationally have limited accuracy in predicting streamflow percentiles corresponding to streamflow drought occurrence or streamflow drought onset/termination more than 4 weeks into the future, and <span class='moderate-emph'>interpreting forecasts for 1-4 weeks may be most useful</span>. Continued model development can benefit from additional inputs, as this model incorporates limited data on subsurface storage and flow modifications, including reservoir releases, diversions, and withdrawals. In addition, there are difficulties in capturing sub-seasonal transitions between streamflow drought and flood conditions."
                    },
                    {
                        type: "text",
                        content: "A known issue with the current modeling approach is that <span class='moderate-emph'>model predictions tend towards forecasts of streamflow drought occurrence being more likely for longer lead times</span>, which may overrepresent the prevalence of streamflow drought more than 4 weeks in advance."
                    },
                    {
                        type: "text",
                        content: "For more information, please refer to the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website and the <a href='https://www.frontiersin.org/journals/water/articles/10.3389/frwa.2025.1709138' target='_blank'>technical documentation of modeling methods and model evaluation</a>."
            ...
            },
            {
                ...
                content: [
                    ...
                    {
                        type: "text",
                        content: "The 1981–2020 period of record is also used to convert predicted percentiles to units of streamflow – cubic feet per second (cfs) – when plotting the predicted streamflow (refer to ‘Why are predictions plotted in units of streamflow (cfs) instead of percentiles?’, below)."
                    },
                    {
                        type: "text",
                        content: "To learn more, visit the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website or refer to the <a href='https://www.frontiersin.org/journals/water/articles/10.3389/frwa.2025.1709138' target='_blank'>technical documentation of modeling methods and model evaluation</a>."
    ...
    graph: {
        ...
        paragraph5: "The uncertainty associated with each weekly streamflow prediction is depicted by a rectangular box behind the median prediction circles. The height of this box represents the <span class='moderate-emph'>90% prediction interval</span>. This interval represents the range of streamflow that the model predicted, excluding the 10% least likely scenarios. When the range of values includes streamflow predictions that are below the <span class='highlight moderate slight-emph'>moderate</span> streamflow drought threshold, the rectangle ‘dips’ into the shaded bands for the streamflow drought categories, showing what categories of streamflow drought are included in the prediction interval. To learn more about the uncertainty of the forecasts, visit the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website.",
