export default {
    siteInfo: {
        ...
        about2: "This tool delivers current streamflow drought conditions and weekly forecasts of streamflow drought at select streamgages with long-term, complete records across the lower 48 states (the conterminous United States, or CONUS).",
    },
    faqs: {
        title: 'FAQs',
        accordionData: [
    ...
    graph: {
        ...
        paragraph3f: "To learn more about streamflow drought thresholds and streamflow percentiles, visit the <a href='https://water.usgs.gov/vizlab/modeling-drought/' target='_blank'>Modeling streamflow drought</a> website.",
