export default {
    siteInfo: {
        ...
        about2: "This <span class='major-emph'>experimental</span> tool delivers current streamflow drought conditions and weekly forecasts of streamflow drought at select streamgages with long-term, complete records across the lower 48 states (the conterminous United States, or CONUS).",
    },
    faqs: {
        title: 'FAQs',
        accordionData: [
